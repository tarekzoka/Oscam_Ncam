...
# ###########################################
#
# Command: wget https://raw.githubusercontent.com/tarekzoka/main/Oscam_Ncam/installer.sh -q; sh installer.sh
#
# ###########################################
...
MY_URL='https://raw.githubusercontent.com/tarekzoka/main/Oscam_Ncam/'
